...
export const ABILITY_DESC: Record<string, string> = {
  ...
  'Stubborn':          'The first hit that would drop this card below 20% HP leaves it at 20% instead.',
  ...
  'Adaptable':         'The first type-advantage hit each time this card enters is reduced to neutral.',
  ...
  'Stamina Leech':     'Drains 1 stamina from the opponent per hit. If faster and the opponent hits 0, their attack is cancelled.',
  'Rested and Ready':  'Entering at full stamina deals 30% bonus damage on the first attack.',
  ...
  'Payback':           'Stores 10% of damage taken each round; releases all stored damage on the next kill.',
  ...
  'Death Mark':        'Marks the opponent on entry. If that card is defeated, your next card enters at full stamina.',
  'Riposte':           'On Rest, negates the free hit and retaliates with 50% of the avoided damage.',

  // ── Legendary ───────────────────────────────────────────────────────────────
  'Apex Predator':      'Each kill permanently raises all stats by 8%; speed bonus applies from the next round',
  'Immunity':           'Immune to Bleed, Intimidate, Dead Weight, Pressure, Dominate, Nullify, and type disadvantage.',
